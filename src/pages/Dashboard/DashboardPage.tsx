...
export function DashboardPage() {
  ...
  const statusCounts = {
    ...
    "in-progress": reports.filter((report) => report.status === "in-progress")
      .length,
  ...
  return (
    <div className={styles.page}>
          ...
          <Card>
            <CardHeader className={styles.statHeader}>
              <CardTitle className={styles.statTitle}>
                {t("dashboard.draftReports")}
              </CardTitle>
              <Icon name="edit_document" className={styles.statIcon} />
            </CardHeader>
            <CardContent>
              <div className={styles.statValue}>{statusCounts.draft}</div>
            </CardContent>
          </Card>
          <Card>
            <CardHeader className={styles.statHeader}>
          ...
          <CardHeader>
            <div className={styles.sectionHeader}>
              <div>
                ...
                <CardDescription>
                  {t("dashboard.recentReportsSubtitle")}
                </CardDescription>
              </div>
              <Link to="/reports">
                  ...
                  >
                    <div className={styles.reportRowLeft}>
                      <div className={styles.fileIconWrap}>
                        <Icon name="description" className={styles.fileIcon} />
                      </div>
                      <div>
                    ...
                    <div className={styles.reportAside}>
                      {t("reports.fileCount", {
                        count: report.uploadedFiles.length,
                      })}
                    </div>
                  </Link>
                ))}
      ...
      <ReportTypeModal
        ...
        onSelectType={(type) =>
          navigate(type === "insurance" ? "/new-report" : "/new-bank-report")
        }
      />
    </div>
  );
